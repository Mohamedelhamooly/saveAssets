...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> saveFileFromAssets() async {
    String imgPath = "Mohamed_Elhamoly_CV.pdf";

    late File image;
    await getFileFromAssets(imgPath).then((file) => image = file);
    if (image != null) {
      print("Dooone");
    }
    // await FileProcess.downloadFile(context: context, pdfData: image.readAsBytesSync() ,fileName:"test");
  }
...
class FileProcess {
  ...
  // static Future<String?> pickPdfFiles () async {
